...
RUN comfy model download --url https://huggingface.co/silveroxides/Chroma1-HD-fp8-scaled/resolve/main/Chroma1-HD-fp8_scaled_rev2.safetensors --relative-path models/unet --filename Chroma1-HD-fp8_scaled_rev2.safetensors
